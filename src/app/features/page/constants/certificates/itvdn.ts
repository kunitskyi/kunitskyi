...
add('TP98835664', 'scrum', 1000, 1719316800, []);
...
add('TP52123138', 'angular_basic', 980, 1714564800, []);
add('TP54924335', 'angular_basic', 1000, 1714564800, []);
...
add('TP40503252', 'react_advanced', 987, 1713700800, []);
add('TP36912772', 'react_advanced', 1000, 1713700800, []);
add('TP56729630', 'react_basic_ua', 1000, 1713700800, []);
add('TP04630253', 'angular_essential', 980, 1713700800, []);
...
add('TP42655050', 'angular_essential', 1000, 1710590400, []);
