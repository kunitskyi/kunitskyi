...
let tagsDeclaration: Record<string, CertificateTag[]> = {};
...
function add(
  ...
  certificates.push({
    ...
    imgs,
    tags: new Set(tagsDeclaration[name]),
  });
}
...
tagsDeclaration = {
  ...
  project_management: [CertificateTag.Management],
  golang: [CertificateTag.Language],
  mongodb: [CertificateTag.DataBase, CertificateTag.Backend],
  scrum: [CertificateTag.Management],
  qa_start: [CertificateTag.Administration],
  jenkins: [CertificateTag.Administration, CertificateTag.DevOps],
  uxui_basic: [CertificateTag.Design],
  asp_web2: [CertificateTag.Csharp],
  unit_test_csharp: [CertificateTag.Csharp],
  entity_framework6: [CertificateTag.Csharp],
  csharp_universal_patterns: [CertificateTag.Csharp, CertificateTag.Theory],
  entity_framework_core_basic: [CertificateTag.Csharp],
  unit_test_php: [
    CertificateTag.Web,
  ...
  uxui_mobile: [CertificateTag.Design],
  unit_test_csharp_ua: [CertificateTag.Csharp],
  asp_core_advance: [CertificateTag.Csharp],
  test_asp_mvc: [CertificateTag.Csharp],
  uxui_start: [CertificateTag.Design],
  asp_signalr: [CertificateTag.Csharp],
  create_asp_ui: [CertificateTag.Csharp],
  csharp_universal_patterns_ua: [CertificateTag.Csharp, CertificateTag.Theory],
  asp_mvc_fundamentals: [CertificateTag.Csharp],
  web_test: [CertificateTag.Web, CertificateTag.Testing],
  magento2: [
    CertificateTag.Web,
    CertificateTag.Php,
  ...
  unity_advanced: [CertificateTag.GameDev],
  unity_start_ua: [CertificateTag.GameDev],
  unity_basic: [CertificateTag.GameDev],
  unity_start: [CertificateTag.GameDev],
  figma_store: [CertificateTag.Design, CertificateTag.Web],
  async_sharp: [CertificateTag.Csharp],
  yii2_advanced: [
    CertificateTag.Web,
    CertificateTag.Php,
    CertificateTag.Framework,
  ...
  web_grid: [CertificateTag.Web, CertificateTag.Css, CertificateTag.Language],
  test_web_apps: [CertificateTag.Web, CertificateTag.Testing],
  vue_start_ua: [
    CertificateTag.Web,
  ...
  design_patterns: [CertificateTag.Theory],
  transact_sql: [CertificateTag.DataBase, CertificateTag.DataBase],
  sql_basic: [CertificateTag.DataBase, CertificateTag.DataBase],
  landing_practice: [CertificateTag.Web, CertificateTag.Frontend],
  vuejs: [
    CertificateTag.Web,
    CertificateTag.Frontend,
    CertificateTag.Framework,
  ...
  csharp_professional: [CertificateTag.Csharp],
  html_css_start: [
    CertificateTag.Web,
    CertificateTag.Frontend,
    CertificateTag.Language,
  ...
  csharp_basic: [CertificateTag.Csharp],
  php_start: [
    CertificateTag.Web,
    CertificateTag.Php,
    CertificateTag.Language,
  ...
  postgresql: [CertificateTag.Backend, CertificateTag.DataBase],
  bootstrap4: [CertificateTag.Web, CertificateTag.Frontend],
  git_ua: [CertificateTag.Administration, CertificateTag.DevOps],
  csharp8_start: [CertificateTag.Csharp],
  react_native: [
    CertificateTag.Framework,
    CertificateTag.Rect,
    CertificateTag.JavaScript,
  ...
  linux_basic: [CertificateTag.Administration, CertificateTag.DevOps],
  js_basic_2021: [
    CertificateTag.Web,
    CertificateTag.Frontend,
    CertificateTag.Language,
  ...
  test_angular: [
    ...
    CertificateTag.TypeScript,
    CertificateTag.JavaScript,
    CertificateTag.Testing,
  ],
  windows_server_basic: [CertificateTag.Administration, CertificateTag.DevOps],
  react_advanced_ua: [
    CertificateTag.Web,
    CertificateTag.Frontend,
    CertificateTag.Framework,
  ...
  docker: [CertificateTag.Administration, CertificateTag.DevOps],
  git: [CertificateTag.Administration, CertificateTag.DevOps],
  algorithms_data_structure_new: [CertificateTag.Theory],
  ...
  mysql_basic: [CertificateTag.Backend, CertificateTag.DataBase],
